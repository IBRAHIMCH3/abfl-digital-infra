...
//
    stage('Check-Out') {
     steps {
        ...
        mv -i variables/.terraform.lock.hcl variables/*.tf variables/config/mumbai/${ABFL_SERVER_NAME}.tfvars ${ABFL_SERVER_NAME}_Dir
	mv -i config/mumbai ${ABFL_SERVER_NAME}_Dir
